...
namespace EatEvals.Models
{
    public class SeedData
    {
        ...
        {
            using (var context = new RestaurantReviewDbContext(
                serviceProvider.GetRequiredService<
                    DbContextOptions<RestaurantReviewDbContext>>()))
            {
                // Look for any Review.
                ...
                context.Review.AddRange(
                    new Review
                    {
                        ...
                        Food = "Salmon",
                        Price = 34.20F,
                        Date = DateTime.Parse("2023-12-01 18:25"),
                        Image = image
                    },
                    new Review
                    {
                        ...
                        Food = "Beef",
                        Price = 28.32F,
                        Date = DateTime.Parse("2023-12-01 20:15"),
                        Image = image
                    },
                    new Review
                    {
                        ...
                        Food = "ABC",
                        Price = 16.12F,
                        Date = DateTime.Parse("2023-12-01 09:01"),
                        Image = image
                    },
                     new Review
                     {
                ...
                catch (Exception ex)
                {
                    ...
                    // You can log the exception or handle it in any other appropriate way
                }
            }
        }
